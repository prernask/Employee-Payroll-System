...
public class SalarySlip {
    ...
    String emp_fnm,emp_lnm,emp_bacc,emp_pan,emp_dept,emp_design,emp_mobile;
    String salary,tax,netsal;

    public SalarySlip(){

    }

    public SalarySlip(String emp_fnm,String emp_lnm,String emp_bacc,String emp_pan,String emp_dept,String emp_design,String emp_mobile,String salary,String tax,String netsal){
